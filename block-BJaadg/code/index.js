...
*/
//  console.log(`The character at index 0 is '${quote[0]}'`);
//  console.log(`The character at index 0 is '${quote[1]}'`);
//  console.log(`The character at index 0 is '${quote[2]}'`);
//  console.log(`The character at index 0 is '${quote[3]}'`);
//  console.log(`The character at index 0 is '${quote[4]}'`);
//  console.log(`The character at index 0 is ' '`);
/*
...
*/
  //  quoteSplitted.splice(10,1,"tommorow");
